...
public class SensorsDataAutoTrackHelper {
    private static  String TAG = "SensorsDataAutoTrackHelper";
    @Keep
    public static void trackViewOnClick(DialogInterface dialogInterface, int whichButton) {
        try {
            ...
            Log.d(TAG,"trackViewOnClick(DialogInterface dialogInterface, int whichButton)");
    ...
    public static void trackViewOnClick(CompoundButton view, boolean isChecked) {
        try {
            ...
            Log.d(TAG,"trackViewOnClick(CompoundButton view, boolean isChecked)");
            SensorsDataAPI.getInstance().track("$AppClick", properties);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void trackViewOnClick(DialogInterface dialogInterface, int whichButton, boolean isChecked) {
        try {
            ...
            properties.put("isChecked", isChecked);
            properties.put("$element_type", "Dialog");
            Log.d(TAG,"trackViewOnClick(DialogInterface dialogInterface, int whichButton, boolean isChecked) ");
            SensorsDataAPI.getInstance().track("$AppClick", properties);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void trackViewOnClick(Object object, MenuItem menuItem) {
        try {
            ...
            Log.d(TAG,"trackViewOnClick(Object object, MenuItem menuItem)");
    ...
    public static void trackExpandableListViewChildOnClick(ExpandableListView expandableListView, View view,
        ...
        try {
            ...
            Log.d(TAG,"trackExpandableListViewChildOnClick");
            SensorsDataAPI.getInstance().track("$AppClick", properties);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void trackViewOnClick(android.widget.AdapterView adapterView, View view, int position) {
        try {
            ...
            Log.d(TAG,"trackViewOnClick(android.widget.AdapterView adapterView, View view, int position)");
            SensorsDataAPI.getInstance().track("$AppClick", properties);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void trackViewOnClick(View view) {
        try {
            ...
            Log.d(TAG,"trackViewOnClick(View view)");
            SensorsDataAPI.getInstance().track("$AppClick", jsonObject);
        } catch (Exception e) {
            e.printStackTrace();
        }
